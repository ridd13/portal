...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.das-portal.online/kiel",
  },
  openGraph: {
    ...
    url: "https://www.das-portal.online/kiel",
    siteName: "Das Portal",
    locale: "de_DE",
    type: "website",
  },
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        ...
        <section className="mt-16 space-y-6 text-text-primary">
          <h2 className="text-2xl font-semibold">
            Warum Kiel ein Hotspot für ganzheitliche Events ist
          </h2>
          <p className="text-text-secondary leading-relaxed">
            Als Landeshauptstadt von Schleswig-Holstein zieht Kiel eine diverse
            Community an: Studierende, junge Familien und eine wachsende Zahl
            von Coaches und Facilitators. Die Nähe zur Ostsee und zur Kieler
            Förde prägt viele Formate — Outdoor-Yoga, Meditationen am Wasser
            und Retreat-Wochenenden im Umland sind typisch für die Region.
          </p>
          <p className="text-text-secondary leading-relaxed">
            Stadtteile wie Gaarden, Schilksee und die Innenstadt haben sich als
            Standorte für Studios und Veranstaltungsräume etabliert. Viele
            Anbieter nutzen auch flexible Locations wie Co-Working Spaces,
            Gemeinschaftsgärten oder private Räume. Das Portal bündelt all diese
            Termine an einem Ort — unabhängig von einzelnen Kanälen.
          </p>
        </section>
