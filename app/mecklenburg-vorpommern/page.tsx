...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.das-portal.online/mecklenburg-vorpommern",
  },
  openGraph: {
    ...
    url: "https://www.das-portal.online/mecklenburg-vorpommern",
    siteName: "Das Portal",
    locale: "de_DE",
    type: "website",
  },
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        ...
        <section className="mt-16 space-y-6 text-text-primary">
          <h2 className="text-2xl font-semibold">
            Ganzheitliche Events zwischen Ostsee und Seenplatte
          </h2>
          <p className="text-text-secondary leading-relaxed">
            Mecklenburg-Vorpommern ist ein Paradies für Retreat-Liebhaber.
            Die Kombination aus Ostseeküste, Seenplatte und weitem Hinterland
            bietet ideale Bedingungen für ganzheitliche Formate in der Natur.
            Gutshäuser und historische Anwesen werden zunehmend als
            Retreat-Locations genutzt — ein Trend der sich in den letzten
            Jahren stark beschleunigt hat.
          </p>
          <p className="text-text-secondary leading-relaxed">
            Rostock ist als größte Stadt des Landes das urbane Zentrum der
            Szene mit aktiven Yoga- und Meditationsgruppen. Die Inseln Rügen
            und Usedom ziehen vor allem im Sommer Retreat-Anbieter an.
            Schwerin, Greifswald und Stralsund haben kleinere, aber
            engagierte Communities. Das Portal macht dieses verteilte
            Angebot erstmals zentral sichtbar.
          </p>
        </section>
        ...
        <section className="mt-16 rounded-3xl bg-linear-to-br from-[#f5ece1] to-[#e8ddd4] p-8 text-center sm:p-12">
          <h2 className="text-2xl font-semibold text-text-primary">
            Du bist Anbieter:in in Mecklenburg-Vorpommern?
          </h2>
